...
class ImagingEvaluationAdapter(layoutResId:Int,data:List<ImagingEvaluationListBean.Data>): BaseQuickAdapter<ImagingEvaluationListBean.Data, BaseViewHolder>(layoutResId,data) {
