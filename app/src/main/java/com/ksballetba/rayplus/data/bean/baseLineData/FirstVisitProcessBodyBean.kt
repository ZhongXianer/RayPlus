...
data class FirstVisitProcessBodyBean(
    ...
    @SerializedName("clinical_symptoms")
    val clinicalSymptoms: ClinicalSymptoms?,
    @SerializedName("gene_mutation_type")
    val geneMutationType: GeneMutationType?,
    ...
    @SerializedName("transfer_site")
    val transferSite: TransferSite?,
